...
public class Version1_1Test 
{
    ...
    public void testQuestions() throws Exception {
        ...
        int cap = 5;                // how many doc titles we're skimming through
        int failed = 0;
        int passed = 0;
        int[] mrr = new int[cap];
        Arrays.fill(mrr, 0);
        ...
        while (reader.hasNextLine()) {
            ...
            if (i % 4 == 0) {
                ...
                try {
                    String test_query = engine.queryBuilderV1(query, topic);
                    ArrayList<Document> documents = engine.searchV1(test_query, cap);
